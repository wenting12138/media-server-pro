...
public final class H264TrackFramePayloadHandler implements TrackFramePayloadHandler {

    public static final H264TrackFramePayloadHandler INSTANCE = new H264TrackFramePayloadHandler();

    private H264TrackFramePayloadHandler() {
    }
